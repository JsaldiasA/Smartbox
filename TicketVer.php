...
echo '<div class="col"><h1><b>Ticket '. $ticket->get_Nombre().' </b></h1> </div>
  <div class="col"> <button class="btn btn-success" href="/TicketForm/TicketFormUpdate.php?id_ticket='.$ticket->get_Id().'"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
