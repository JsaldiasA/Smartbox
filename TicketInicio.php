...
echo '<style>body{background-color: #000714; color: #FFFFFF}</style>';
echo '<style>.container{background-color: #0D0014;color: #FFFFFF;padding: 20px;border-radius: 8px;}</style>';
