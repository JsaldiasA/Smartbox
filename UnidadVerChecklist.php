...
if($HasChecklist == true)
	{   
		...
		echo "<tr><td><b>Técnico responsable:</b></td><td>". $checklistDbEntity->get_TecnicoResponsable(). "</td></tr>";
		$checklistMotivo = $Model->CheckListMotivoById($checklistDbEntity->get_id_checklistMotivo());
		echo "<tr><td><b>Motivo del checklist:</b></td><td>". $checklistMotivo->get_Nombre(). "</td></tr>";
		echo "<tr><td><b>Tipo de unidad: </b></td><td>". $checklistDbEntity->get_id_unidadtipo(). "</td></tr>";
		echo "<tr><td><b>Voltaje regulador de batería:</b></td><td>". $checklistDbEntity->get_VoltajeReguladorBat(). "</td></tr>";
		echo "<tr><td><b>Voltaje regulador de MCU:</b></td><td>". $checklistDbEntity->get_VoltajeReguladorMCU(). "</td></tr>";
		echo "<tr><td><b>Voltaje MCU:</b></td><td>". $checklistDbEntity->get_VoltajeMCU(). "</td></tr>";
		echo "<tr><td><b>SmartBox:</b></td><td>". $checklistDbEntity->get_SmartBox(). "</td></tr>";
		echo "<tr><td><b>Envío SMS:</b></td><td>". $checklistDbEntity->get_SMSenvio(). "</td></tr>";
		echo "<tr><td><b>Recepción SMS:</b></td><td>". $checklistDbEntity->get_SMSrecibo(). "</td></tr>";
	...
	{
		echo '<h1>Checklist no encontrado.</h1>';
	}
?>
</body>
</html>