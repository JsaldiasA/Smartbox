...
$checklistDbEntity= $Model->MYSQLSelectWHERE('checklist','Id',$CheckList_Id)[0];
		...
		<div class="col p-3 d-flex justify-content-end"> <a href="/checklistForm/checklistFormUpdate.php?Id_checklist='.$checklistDbEntity->Id.'"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
