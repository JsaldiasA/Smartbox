...
$externalapps =$model->get_externalapps_monitor();
...
foreach ($externalapps as $app)
{
		...
		echo ($app->DiffBetweenNow_and_LastUpdate() == "0 Min") ? '<td style="color: green;" >Connectado</td>' : '<td style="color: red;">Desconectado</td>';
